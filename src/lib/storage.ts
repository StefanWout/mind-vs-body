  ...
  getEntries: async (): Promise<DailyEntry[]> => {
    try {
      ...
      return (data || []).map(entry => ({
        ...
        morningProductivity: entry.morning_productivity,
        afternoonProductivity: entry.afternoon_productivity,
        ...
        wentToGym: entry.went_to_gym,
        gymIntensity: entry.gym_intensity,
        notes: entry.notes,
  ...
  saveEntry: async (entry: DailyEntry): Promise<void> => {
    try {
      ...
      const dbEntry = {
        ...
        morning_productivity: entry.morningProductivity,
        afternoon_productivity: entry.afternoonProductivity,
        ...
        went_to_gym: entry.wentToGym,
        gym_intensity: entry.gymIntensity,
        notes: entry.notes
      };
  ...
  getEntryByDate: async (date: string): Promise<DailyEntry | null> => {
    try {
      ...
      return {
        ...
        morningProductivity: data.morning_productivity,
        afternoonProductivity: data.afternoon_productivity,
        ...
        wentToGym: data.went_to_gym,
        gymIntensity: data.gym_intensity,
        notes: data.notes,
